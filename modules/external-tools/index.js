...
export class ExternalToolsModule extends Module {
  constructor() {
    super({ id: 'external-tools', name: 'External Analysis', version: '1.0.0', apiVersion: '1.0.0', author: 'ProfessorSr', description: 'Generate, copy, and explicitly open links or payloads for external base-analysis tools.', permissions: ['game', 'settings', 'windows'], settings: {

...
export class WorldToolsModule extends Module {
  constructor() { super({ id:'world-tools', name:'World Map Tools', version:'0.2.0', apiVersion:'1.0.0', author:'ProfessorSr', description:'Coordinate navigation, compasses, sector HUD, zoom, and regional object inspection.', permissions:['game','settings','windows'], settings:{ zoom:{type:'number',default:1,min:0.2,max:3} } }); this.record=null; }

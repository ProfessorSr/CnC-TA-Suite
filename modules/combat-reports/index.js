...
export class CombatReportsModule extends Module {
  constructor() { super({ id: 'combat-reports', name: 'Combat Reports', version: '0.2.0', apiVersion: '1.0.0', author: 'ProfessorSr', description: 'Filter, aggregate, trend, and export combat report history.', permissions: ['game', 'storage', 'windows'], settings: {} }); }

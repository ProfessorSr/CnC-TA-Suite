# CnC-TA-Suite v1.1.0 Documentation Index

This index identifies the principal maintained documentation and release metadata. Historical v0.3.0 and v0.4.0 validation records remain in place as release evidence.

## Start here

- `README.md` — product overview, safety boundary, build and test commands.
...
- `modules/command-manual/` — in-extension searchable user documentation discovered from enabled module manifests.
- `modules/*/README.md` — module-owned behavior, controls, persistence, and safety notes, including Player Intelligence, Alliance Intelligence, Scanner, War Room, Research ETA, and Upgrade Manager.

The remaining files under `docs/` provide focused architecture, UI, development, module, reference, and decision records.
